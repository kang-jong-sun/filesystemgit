...
def bt(c, h, l, fm, sm, adx, rsi, n, SL, TA, TSL, MON, SKIP, WU, MPCT, USE_FILTER):
    ...
    for i in range(WU, n):
        ...
        if pos != 0:
            ...
            if et>0:
                ...
                trades.append({'i': i, 'pnl': pnl, 'et': et})
                ld=pos; pos=0
                if cap>pk: pk=cap
...
print()
print("=" * 80)
print("  BTC v32.2 — 6-Engine + 30x Cross Verification")
print("  30m EMA(100)/EMA(600) | SL3% TA12% TSL9% | 35% Margin | Filter ON")
print("=" * 80)

# 6-Engine
caps = []
for _ in range(6):
    r = bt(c, h, l, fm, sm, adx, rsi, n, 3.0, 12.0, 9.0, 24, True, 600, 0.35, True)
    caps.append(r[0])
